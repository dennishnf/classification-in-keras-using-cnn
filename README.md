...
# Simple Classification in Keras-Tensorflow using CNN #
...
This repository provides basic example of classification using Convolutional Neural Networks (CNNs), and also using the frameworks Keras and Tensorflow. You can run the example and train your own model using your own dataset. The example is intended to be executed in two independent ways: in Google Colab and in Native Python.
